...
Write-Host "??? Verificando propiedades del GeoJSON de comunas..." -ForegroundColor Cyan
...
Write-Host "??? Verificando propiedades del GeoJSON de barrios..." -ForegroundColor Cyan
